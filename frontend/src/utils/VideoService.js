...
class VideoService {
  ...
  static async getEvaluationForm(videoId) {
    ...
    try {
      console.log(`Fetching evaluation form for video ID: ${videoId}`);
      const response = await ApiService.get(`evaluation-forms/video/${videoId}`);
      console.log(`Fetched evaluation form for video ID: ${videoId}`, response);
      return response;
    } catch (error) {
      console.error(`Error fetching evaluation form for video ID ${videoId}:`, error);
      throw error;
    }
  }
  ...
  static async createEvaluationForm(videoId, formData) {
    ...
    try {
      console.log(`Creating evaluation form for video ID: ${videoId}`);
      const response = await ApiService.post(`evaluation-forms/video/${videoId}`, formData);
      console.log(`Created evaluation form for video ID: ${videoId}`, response);
      return response;
    } catch (error) {
      console.error(`Error creating evaluation form for video ID ${videoId}:`, error);
      throw error;
    }
  }
  ...
  static async updateEvaluationForm(videoId, formData) {
    ...
    try {
      console.log(`Updating evaluation form for video ID: ${videoId}`);
      const response = await ApiService.put(`evaluation-forms/video/${videoId}`, formData);
      console.log(`Updated evaluation form for video ID: ${videoId}`, response);
      return response;
    } catch (error) {
      console.error(`Error updating evaluation form for video ID ${videoId}:`, error);
      throw error;
    }
  }
