...
const UserWatchHistory = () => {
  ...
  const updateDisplayedVideos = useCallback((videos, currentPage, resetPage = false) => {
    ...
    const sorted = [...filtered].sort((a, b) => {
      const dateA = a.last_watched ? new Date(a.last_watched) : (a.upload_date ? new Date(a.upload_date) : new Date(0));
      const dateB = b.last_watched ? new Date(b.last_watched) : (b.upload_date ? new Date(b.upload_date) : new Date(0));
