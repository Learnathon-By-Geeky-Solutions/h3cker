...
from .utils import should_make_private, make_video_private
...
class VideoAdmin(admin.ModelAdmin):
    ...
    actions = ['make_videos_private', 'make_videos_public', 'reset_video_statistics', 
               'create_new_share_links', 'check_privacy_limits', 'export_video_data']
    list_per_page = 25
    ...
    def make_videos_private(self, request, queryset):
        ...
        self.message_user(request, f"{updated} videos were successfully marked as private.")
    ...
    def make_videos_public(self, request, queryset):
        ...
        self.message_user(request, f"{updated} videos were successfully marked as public.")
    ...
    reset_video_statistics.short_description = "Reset views and likes for selected videos"
    ...
    create_new_share_links.short_description = "Generate new share links for selected videos"
    ...
    def export_video_data(self, request, queryset):
        ...
        writer.writerow(['ID', 'Title', 'Uploader', 'Category', 'Visibility', 
                         'Views', 'Likes', 'Upload Date', 'Duration', 'View Limit'])
